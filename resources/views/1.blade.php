...
<head>
    ...
    <title>Sign Up - Bergabung Dengan Kami</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="signup-container">
        <div class="signup-header">
            ...
            <p class="signup-subtitle">Buat akun baru dan mulai perjalanan Anda bersama kami</p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST" class="signup-form" id="signupForm">
            ...
            <div class="form-group">
                <input type="password" class="form-input" placeholder="Konfirmasi Password" id="confirmPassword" required>
                <span class="input-icon">🔐</span>
            </div>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            button.innerHTML = '<span style="display: inline-block; animation: spin 1s linear infinite;">⟳</span> Mendaftar...';
            
            // Simulate signup process
            setTimeout(() => {
                container.classList.remove('loading');
                successMessage.classList.add('show');
                button.innerHTML = '✓ Berhasil Terdaftar!';
